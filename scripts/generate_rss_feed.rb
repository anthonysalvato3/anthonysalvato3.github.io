    ...
    xml.rss(:version => "2.0") do
      xml.channel do
        ...
        # Add the test item at the top
          xml.item do
            xml.title "Test For Image 3"
            xml.link "https://example.com/test-for-image3/"
            xml.description "This is a test item for the image 3."
            xml.pubDate Time.now.rfc2822
            xml.guid "https://example.com/test-for-image3"
